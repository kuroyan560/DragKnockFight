...
void MaskSceneTransition::OnDraw()
{
	...
	/*DrawFunc_Mask::DrawGraphByMaskGraph(windowCenter, KuroEngine::Instance().GetDeD12App().GetBackBuffRenderTarget(), windowCenter, TexHandleMgr::GetTexBuffer(maskHandle), Vec2<bool>(false, false));*/
